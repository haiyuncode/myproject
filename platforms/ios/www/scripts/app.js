...
angular.module('main')
  ...
  .controller('ReceiptCtrl', function ($scope, $http, $q, cmsApi, Loki) {
    ...
    try {
      $http.get('https://cdn.contentful.com/spaces/wiydhpfvx7qb/entries/3NB130JtnWOOoogi6s4w6q?access_token=3e89ff15f153f0bf8a1b97818f32c5883f7f582a8be329fdbefde21ea375aaa7')
        .success(function (data, status) {
          console.log('Received CMS Repository data via HTTP.', data, status);
          //self.leagueDataCache.put(cacheKey, data);
          //$ionicLoading.hide();
